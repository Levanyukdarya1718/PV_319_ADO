...
namespace AcademyDataSet
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            Check();
            //Загружаем направления из бызы в ComboBox:
            ...
            //2) Из множества полей таблицы нужно указать какое поле будет отображаться в выподающем списке
            cbDirections.DisplayMember = "direction_name";
            //3) и какое поле будет возвращаться при быборе элемента ComboBox
      ...
      public  void Load()
        ...
        void LoadGroupsRelatedData()
        {
            ...
            //3) Сроим связи между таблицами
            string dsRelation_GroupsDirections = "GroupsDirection";
            GroupsRelatedData.Relations.Add
                (
               dsRelation_GroupsDirections ,//RelationName
